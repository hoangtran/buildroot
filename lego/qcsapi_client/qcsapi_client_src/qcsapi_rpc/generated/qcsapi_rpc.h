...
struct qcsapi_get_qfdr_parameter_rpcdata {
	__rpc_string *param_name;
	uint32_t max_param_len;
	__rpc_string *param_value;
	int return_code;
};
typedef struct qcsapi_get_qfdr_parameter_rpcdata qcsapi_get_qfdr_parameter_rpcdata;

struct qcsapi_set_qfdr_parameter_rpcdata {
	__rpc_string *param_name;
	__rpc_string *param_value;
	int return_code;
};
typedef struct qcsapi_set_qfdr_parameter_rpcdata qcsapi_set_qfdr_parameter_rpcdata;

struct qcsapi_get_qfdr_state_rpcdata {
	__rpc_string *ifname;
	int *state;
	int return_code;
};
typedef struct qcsapi_get_qfdr_state_rpcdata qcsapi_get_qfdr_state_rpcdata;
...
struct qcsapi_get_device_mode_rpcdata {
	__rpc_string *ifname;
	int *cur_mode;
	int return_code;
};
typedef struct qcsapi_get_device_mode_rpcdata qcsapi_get_device_mode_rpcdata;
...
struct qcsapi_get_stored_ipaddr_rpcdata {
	u_int maxlen;
	__rpc_string *ipaddr;
	int return_code;
};
typedef struct qcsapi_get_stored_ipaddr_rpcdata qcsapi_get_stored_ipaddr_rpcdata;
...
struct qcsapi_wifi_associate_noscan_rpcdata {
	__rpc_string *ifname;
	__rpc_string *join_ssid;
	int return_code;
};
typedef struct qcsapi_wifi_associate_noscan_rpcdata qcsapi_wifi_associate_noscan_rpcdata;
...
struct qcsapi_wifi_set_autochan_params_rpcdata {
	__rpc_string *ifname;
	int type;
	int param_value;
	int return_code;
};
typedef struct qcsapi_wifi_set_autochan_params_rpcdata qcsapi_wifi_set_autochan_params_rpcdata;

struct qcsapi_wifi_get_autochan_params_rpcdata {
	__rpc_string *ifname;
	int type;
	int *p_value;
	int return_code;
};
typedef struct qcsapi_wifi_get_autochan_params_rpcdata qcsapi_wifi_get_autochan_params_rpcdata;

struct qcsapi_wifi_update_autochan_params_rpcdata {
	__rpc_string *ifname;
	__rpc_string *param_name;
	__rpc_string *param_value;
	int return_code;
};
typedef struct qcsapi_wifi_update_autochan_params_rpcdata qcsapi_wifi_update_autochan_params_rpcdata;

struct qcsapi_wifi_wds_get_psk_rpcdata {
	__rpc_string *ifname;
	__rpc_qcsapi_mac_addr_p peer_address;
...
typedef struct qcsapi_wifi_wds_get_psk_rpcdata qcsapi_wifi_wds_get_psk_rpcdata;
...
struct qcsapi_wifi_set_eap_own_ip_addr_rpcdata {
	__rpc_string *ifname;
	__rpc_string *eap_own_ip_addr;
	int return_code;
};
typedef struct qcsapi_wifi_set_eap_own_ip_addr_rpcdata qcsapi_wifi_set_eap_own_ip_addr_rpcdata;

struct qcsapi_wifi_get_eap_own_ip_addr_rpcdata {
	__rpc_string *ifname;
	__rpc_string *eap_own_ip_addr;
	int return_code;
};
typedef struct qcsapi_wifi_get_eap_own_ip_addr_rpcdata qcsapi_wifi_get_eap_own_ip_addr_rpcdata;
...
struct qcsapi_wifi_get_radius_acct_interim_interval_rpcdata {
	__rpc_string *ifname;
	u_int *interval;
	int return_code;
};
typedef struct qcsapi_wifi_get_radius_acct_interim_interval_rpcdata qcsapi_wifi_get_radius_acct_interim_interval_rpcdata;

struct qcsapi_wifi_set_radius_acct_interim_interval_rpcdata {
	__rpc_string *ifname;
	u_int interval;
	int return_code;
};
typedef struct qcsapi_wifi_set_radius_acct_interim_interval_rpcdata qcsapi_wifi_set_radius_acct_interim_interval_rpcdata;
...
struct qcsapi_wifi_add_temporary_mac_filter_addr_rpcdata {
	__rpc_string *ifname;
	__rpc_string *accept_deny;
	__rpc_qcsapi_mac_addr_p address;
	int return_code;
};
typedef struct qcsapi_wifi_add_temporary_mac_filter_addr_rpcdata qcsapi_wifi_add_temporary_mac_filter_addr_rpcdata;

struct qcsapi_wifi_del_temporary_mac_filter_addr_rpcdata {
	__rpc_string *ifname;
	__rpc_string *accept_deny;
	__rpc_qcsapi_mac_addr_p address;
	int return_code;
};
typedef struct qcsapi_wifi_del_temporary_mac_filter_addr_rpcdata qcsapi_wifi_del_temporary_mac_filter_addr_rpcdata;
...
struct qcsapi_wps_configure_ap_rpcdata {
	__rpc_string *ifname;
	__rpc_string *bssid;
	__rpc_string *ap_pin;
	__rpc_string *new_ssid;
	__rpc_string *new_auth;
	__rpc_string *new_encr;
	__rpc_string *new_key;
	int return_code;
};
typedef struct qcsapi_wps_configure_ap_rpcdata qcsapi_wps_configure_ap_rpcdata;
...
struct qcsapi_wifi_set_rx_nss_cap_rpcdata {
	__rpc_string *ifname;
	int modulation;
	u_int nss;
	int return_code;
};
typedef struct qcsapi_wifi_set_rx_nss_cap_rpcdata qcsapi_wifi_set_rx_nss_cap_rpcdata;

struct qcsapi_wifi_get_rx_nss_cap_rpcdata {
	__rpc_string *ifname;
	int modulation;
	u_int *nss;
	int return_code;
};
typedef struct qcsapi_wifi_get_rx_nss_cap_rpcdata qcsapi_wifi_get_rx_nss_cap_rpcdata;
...
struct qcsapi_wifi_get_btm_cap_rpcdata {
	__rpc_string *ifname;
	int *btm_cap;
	int return_code;
};
typedef struct qcsapi_wifi_get_btm_cap_rpcdata qcsapi_wifi_get_btm_cap_rpcdata;

struct qcsapi_wifi_set_btm_cap_rpcdata {
	__rpc_string *ifname;
	int btm_cap;
	int return_code;
};
typedef struct qcsapi_wifi_set_btm_cap_rpcdata qcsapi_wifi_set_btm_cap_rpcdata;

struct qcsapi_wifi_get_rm_neigh_report_rpcdata {
	__rpc_string *ifname;
	int *neigh_repo;
	int return_code;
};
typedef struct qcsapi_wifi_get_rm_neigh_report_rpcdata qcsapi_wifi_get_rm_neigh_report_rpcdata;

struct qcsapi_wifi_set_rm_neigh_report_rpcdata {
	__rpc_string *ifname;
	int neigh_repo;
	int return_code;
};
typedef struct qcsapi_wifi_set_rm_neigh_report_rpcdata qcsapi_wifi_set_rm_neigh_report_rpcdata;

struct qcsapi_set_unknown_dest_discover_intval_rpcdata {
	__rpc_string *ifname;
	u_int intval;
	int return_code;
};
typedef struct qcsapi_set_unknown_dest_discover_intval_rpcdata qcsapi_set_unknown_dest_discover_intval_rpcdata;

struct qcsapi_get_unknown_dest_discover_intval_rpcdata {
	__rpc_string *ifname;
	u_int *intval;
	int return_code;
};
typedef struct qcsapi_get_unknown_dest_discover_intval_rpcdata qcsapi_get_unknown_dest_discover_intval_rpcdata;
...
struct qcsapi_calcmd_check_rfic_health_rpcdata {
	u_int *value;
	int return_code;
};
typedef struct qcsapi_calcmd_check_rfic_health_rpcdata qcsapi_calcmd_check_rfic_health_rpcdata;
...
struct qcsapi_get_app_core_dump_ext_rpcdata {
	__rpc_string *file;
	uint32_t bytes_to_copy;
	uint32_t offset;
	__rpc_string *buf;
...
typedef struct qcsapi_get_app_core_dump_ext_rpcdata qcsapi_get_app_core_dump_ext_rpcdata;
...
struct qcsapi_wifi_get_vopt_rpcdata {
	__rpc_string *ifname;
	int *vopt_value;
	int return_code;
};
typedef struct qcsapi_wifi_get_vopt_rpcdata qcsapi_wifi_get_vopt_rpcdata;

struct qcsapi_wifi_set_vopt_rpcdata {
	__rpc_string *ifname;
	int vopt_value;
	int return_code;
};
typedef struct qcsapi_wifi_set_vopt_rpcdata qcsapi_wifi_set_vopt_rpcdata;
...
struct qcsapi_set_report_flood_interval_rpcdata {
	__rpc_string *ifname;
	uint32_t val;
	int return_code;
};
typedef struct qcsapi_set_report_flood_interval_rpcdata qcsapi_set_report_flood_interval_rpcdata;

struct qcsapi_get_report_flood_interval_rpcdata {
	__rpc_string *ifname;
	uint32_t *val;
	int return_code;
};
typedef struct qcsapi_get_report_flood_interval_rpcdata qcsapi_get_report_flood_interval_rpcdata;

struct qcsapi_get_pd_voltage_level_rpcdata {
	int *p_chains;
	__rpc_qcsapi_int_array32 *p_values;
	int return_code;
};
typedef struct qcsapi_get_pd_voltage_level_rpcdata qcsapi_get_pd_voltage_level_rpcdata;

struct qcsapi_wifi_reload_security_config_rpcdata {
	__rpc_string *ifname;
	int return_code;
};
typedef struct qcsapi_wifi_reload_security_config_rpcdata qcsapi_wifi_reload_security_config_rpcdata;

struct qcsapi_enable_emac_sdp_rpcdata {
	u_int enable;
	int return_code;
};
typedef struct qcsapi_enable_emac_sdp_rpcdata qcsapi_enable_emac_sdp_rpcdata;

struct qcsapi_wifi_set_bss_rxscan_rpcdata {
	__rpc_string *ifname;
	__rpc_qcsapi_mac_addr_p bssid;
	int chan;
	int return_code;
};
typedef struct qcsapi_wifi_set_bss_rxscan_rpcdata qcsapi_wifi_set_bss_rxscan_rpcdata;
...
#define QCSAPI_GET_QFDR_PARAMETER_REMOTE 7071
extern  enum clnt_stat qcsapi_get_qfdr_parameter_remote_1(qcsapi_get_qfdr_parameter_rpcdata *, qcsapi_get_qfdr_parameter_rpcdata *, CLIENT *);
extern  bool_t qcsapi_get_qfdr_parameter_remote_1_svc(qcsapi_get_qfdr_parameter_rpcdata *, qcsapi_get_qfdr_parameter_rpcdata *, struct svc_req *);
#define QCSAPI_SET_QFDR_PARAMETER_REMOTE 7081
extern  enum clnt_stat qcsapi_set_qfdr_parameter_remote_1(qcsapi_set_qfdr_parameter_rpcdata *, qcsapi_set_qfdr_parameter_rpcdata *, CLIENT *);
extern  bool_t qcsapi_set_qfdr_parameter_remote_1_svc(qcsapi_set_qfdr_parameter_rpcdata *, qcsapi_set_qfdr_parameter_rpcdata *, struct svc_req *);
#define QCSAPI_GET_QFDR_STATE_REMOTE 8941
extern  enum clnt_stat qcsapi_get_qfdr_state_remote_1(qcsapi_get_qfdr_state_rpcdata *, qcsapi_get_qfdr_state_rpcdata *, CLIENT *);
extern  bool_t qcsapi_get_qfdr_state_remote_1_svc(qcsapi_get_qfdr_state_rpcdata *, qcsapi_get_qfdr_state_rpcdata *, struct svc_req *);
...
extern  enum clnt_stat qcsapi_wifi_set_scs_active_chan_list_remote_1(qcsapi_wifi_set_scs_active_chan_list_rpcdata *, qcsapi_wifi_set_scs_active_chan_list_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_set_scs_active_chan_list_remote_1_svc(qcsapi_wifi_set_scs_active_chan_list_rpcdata *, qcsapi_wifi_set_scs_active_chan_list_rpcdata *, struct svc_req *);
#define QCSAPI_WIFI_GET_SCS_ACTIVE_CHAN_LIST_REMOTE 8891
extern  enum clnt_stat qcsapi_wifi_get_scs_active_chan_list_remote_1(qcsapi_wifi_get_scs_active_chan_list_rpcdata *, qcsapi_wifi_get_scs_active_chan_list_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_get_scs_active_chan_list_remote_1_svc(qcsapi_wifi_get_scs_active_chan_list_rpcdata *, qcsapi_wifi_get_scs_active_chan_list_rpcdata *, struct svc_req *);
...
extern  enum clnt_stat qcsapi_wifi_set_scs_sample_type_remote_1(qcsapi_wifi_set_scs_sample_type_rpcdata *, qcsapi_wifi_set_scs_sample_type_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_set_scs_sample_type_remote_1_svc(qcsapi_wifi_set_scs_sample_type_rpcdata *, qcsapi_wifi_set_scs_sample_type_rpcdata *, struct svc_req *);
...
extern  enum clnt_stat qcsapi_wifi_get_scs_interference_report_remote_1(qcsapi_wifi_get_scs_interference_report_rpcdata *, qcsapi_wifi_get_scs_interference_report_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_get_scs_interference_report_remote_1_svc(qcsapi_wifi_get_scs_interference_report_rpcdata *, qcsapi_wifi_get_scs_interference_report_rpcdata *, struct svc_req *);
...
extern  enum clnt_stat qcsapi_wifi_set_scs_nac_monitor_mode_remote_1(qcsapi_wifi_set_scs_nac_monitor_mode_rpcdata *, qcsapi_wifi_set_scs_nac_monitor_mode_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_set_scs_nac_monitor_mode_remote_1_svc(qcsapi_wifi_set_scs_nac_monitor_mode_rpcdata *, qcsapi_wifi_set_scs_nac_monitor_mode_rpcdata *, struct svc_req *);
...
extern  enum clnt_stat qcsapi_wifi_set_scs_burst_enable_remote_1(qcsapi_wifi_set_scs_burst_enable_rpcdata *, qcsapi_wifi_set_scs_burst_enable_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_set_scs_burst_enable_remote_1_svc(qcsapi_wifi_set_scs_burst_enable_rpcdata *, qcsapi_wifi_set_scs_burst_enable_rpcdata *, struct svc_req *);
#define QCSAPI_WIFI_SET_SCS_BURST_WINDOW_REMOTE 234
extern  enum clnt_stat qcsapi_wifi_set_scs_burst_window_remote_1(qcsapi_wifi_set_scs_burst_window_rpcdata *, qcsapi_wifi_set_scs_burst_window_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_set_scs_burst_window_remote_1_svc(qcsapi_wifi_set_scs_burst_window_rpcdata *, qcsapi_wifi_set_scs_burst_window_rpcdata *, struct svc_req *);
#define QCSAPI_WIFI_SET_SCS_BURST_THRESH_REMOTE 235
extern  enum clnt_stat qcsapi_wifi_set_scs_burst_thresh_remote_1(qcsapi_wifi_set_scs_burst_thresh_rpcdata *, qcsapi_wifi_set_scs_burst_thresh_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_set_scs_burst_thresh_remote_1_svc(qcsapi_wifi_set_scs_burst_thresh_rpcdata *, qcsapi_wifi_set_scs_burst_thresh_rpcdata *, struct svc_req *);
#define QCSAPI_WIFI_SET_SCS_BURST_PAUSE_REMOTE 236
extern  enum clnt_stat qcsapi_wifi_set_scs_burst_pause_remote_1(qcsapi_wifi_set_scs_burst_pause_rpcdata *, qcsapi_wifi_set_scs_burst_pause_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_set_scs_burst_pause_remote_1_svc(qcsapi_wifi_set_scs_burst_pause_rpcdata *, qcsapi_wifi_set_scs_burst_pause_rpcdata *, struct svc_req *);
#define QCSAPI_WIFI_SET_SCS_BURST_SWITCH_REMOTE 237
extern  enum clnt_stat qcsapi_wifi_set_scs_burst_switch_remote_1(qcsapi_wifi_set_scs_burst_switch_rpcdata *, qcsapi_wifi_set_scs_burst_switch_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_set_scs_burst_switch_remote_1_svc(qcsapi_wifi_set_scs_burst_switch_rpcdata *, qcsapi_wifi_set_scs_burst_switch_rpcdata *, struct svc_req *);
...
extern  enum clnt_stat qcsapi_wifi_get_icac_status_remote_1(qcsapi_wifi_get_icac_status_rpcdata *, qcsapi_wifi_get_icac_status_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_get_icac_status_remote_1_svc(qcsapi_wifi_get_icac_status_rpcdata *, qcsapi_wifi_get_icac_status_rpcdata *, struct svc_req *);
...
#define QCSAPI_GET_DEVICE_MODE_REMOTE 7241
extern  enum clnt_stat qcsapi_get_device_mode_remote_1(qcsapi_get_device_mode_rpcdata *, qcsapi_get_device_mode_rpcdata *, CLIENT *);
extern  bool_t qcsapi_get_device_mode_remote_1_svc(qcsapi_get_device_mode_rpcdata *, qcsapi_get_device_mode_rpcdata *, struct svc_req *);
...
#define QCSAPI_GET_STORED_IPADDR_REMOTE 8691
extern  enum clnt_stat qcsapi_get_stored_ipaddr_remote_1(qcsapi_get_stored_ipaddr_rpcdata *, qcsapi_get_stored_ipaddr_rpcdata *, CLIENT *);
extern  bool_t qcsapi_get_stored_ipaddr_remote_1_svc(qcsapi_get_stored_ipaddr_rpcdata *, qcsapi_get_stored_ipaddr_rpcdata *, struct svc_req *);
...
extern  enum clnt_stat qcsapi_wifi_get_chan_usable_remote_1(qcsapi_wifi_get_chan_usable_rpcdata *, qcsapi_wifi_get_chan_usable_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_get_chan_usable_remote_1_svc(qcsapi_wifi_get_chan_usable_rpcdata *, qcsapi_wifi_get_chan_usable_rpcdata *, struct svc_req *);
...
#define QCSAPI_WIFI_ASSOCIATE_NOSCAN_REMOTE 872
extern  enum clnt_stat qcsapi_wifi_associate_noscan_remote_1(qcsapi_wifi_associate_noscan_rpcdata *, qcsapi_wifi_associate_noscan_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_associate_noscan_remote_1_svc(qcsapi_wifi_associate_noscan_rpcdata *, qcsapi_wifi_associate_noscan_rpcdata *, struct svc_req *);
...
extern  enum clnt_stat qcsapi_wifi_get_ac_agg_hold_time_remote_1(qcsapi_wifi_get_ac_agg_hold_time_rpcdata *, qcsapi_wifi_get_ac_agg_hold_time_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_get_ac_agg_hold_time_remote_1_svc(qcsapi_wifi_get_ac_agg_hold_time_rpcdata *, qcsapi_wifi_get_ac_agg_hold_time_rpcdata *, struct svc_req *);
#define QCSAPI_WIFI_SET_AC_AGG_HOLD_TIME_REMOTE 8831
extern  enum clnt_stat qcsapi_wifi_set_ac_agg_hold_time_remote_1(qcsapi_wifi_set_ac_agg_hold_time_rpcdata *, qcsapi_wifi_set_ac_agg_hold_time_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_set_ac_agg_hold_time_remote_1_svc(qcsapi_wifi_set_ac_agg_hold_time_rpcdata *, qcsapi_wifi_set_ac_agg_hold_time_rpcdata *, struct svc_req *);
...
extern  enum clnt_stat qcsapi_wifi_wds_set_psk_remote_1(qcsapi_wifi_wds_set_psk_rpcdata *, qcsapi_wifi_wds_set_psk_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_wds_set_psk_remote_1_svc(qcsapi_wifi_wds_set_psk_rpcdata *, qcsapi_wifi_wds_set_psk_rpcdata *, struct svc_req *);
...
#define QCSAPI_WIFI_SET_AUTOCHAN_PARAMS_REMOTE 7681
extern  enum clnt_stat qcsapi_wifi_set_autochan_params_remote_1(qcsapi_wifi_set_autochan_params_rpcdata *, qcsapi_wifi_set_autochan_params_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_set_autochan_params_remote_1_svc(qcsapi_wifi_set_autochan_params_rpcdata *, qcsapi_wifi_set_autochan_params_rpcdata *, struct svc_req *);
#define QCSAPI_WIFI_GET_AUTOCHAN_PARAMS_REMOTE 7671
extern  enum clnt_stat qcsapi_wifi_get_autochan_params_remote_1(qcsapi_wifi_get_autochan_params_rpcdata *, qcsapi_wifi_get_autochan_params_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_get_autochan_params_remote_1_svc(qcsapi_wifi_get_autochan_params_rpcdata *, qcsapi_wifi_get_autochan_params_rpcdata *, struct svc_req *);
#define QCSAPI_WIFI_UPDATE_AUTOCHAN_PARAMS_REMOTE 7691
extern  enum clnt_stat qcsapi_wifi_update_autochan_params_remote_1(qcsapi_wifi_update_autochan_params_rpcdata *, qcsapi_wifi_update_autochan_params_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_update_autochan_params_remote_1_svc(qcsapi_wifi_update_autochan_params_rpcdata *, qcsapi_wifi_update_autochan_params_rpcdata *, struct svc_req *);
#define QCSAPI_WIFI_WDS_GET_PSK_REMOTE 7701
extern  enum clnt_stat qcsapi_wifi_wds_get_psk_remote_1(qcsapi_wifi_wds_get_psk_rpcdata *, qcsapi_wifi_wds_get_psk_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_wds_get_psk_remote_1_svc(qcsapi_wifi_wds_get_psk_rpcdata *, qcsapi_wifi_wds_get_psk_rpcdata *, struct svc_req *);
...
#define QCSAPI_WIFI_SET_EAP_OWN_IP_ADDR_REMOTE 1882
extern  enum clnt_stat qcsapi_wifi_set_eap_own_ip_addr_remote_1(qcsapi_wifi_set_eap_own_ip_addr_rpcdata *, qcsapi_wifi_set_eap_own_ip_addr_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_set_eap_own_ip_addr_remote_1_svc(qcsapi_wifi_set_eap_own_ip_addr_rpcdata *, qcsapi_wifi_set_eap_own_ip_addr_rpcdata *, struct svc_req *);
#define QCSAPI_WIFI_GET_EAP_OWN_IP_ADDR_REMOTE 1883
extern  enum clnt_stat qcsapi_wifi_get_eap_own_ip_addr_remote_1(qcsapi_wifi_get_eap_own_ip_addr_rpcdata *, qcsapi_wifi_get_eap_own_ip_addr_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_get_eap_own_ip_addr_remote_1_svc(qcsapi_wifi_get_eap_own_ip_addr_rpcdata *, qcsapi_wifi_get_eap_own_ip_addr_rpcdata *, struct svc_req *);
...
#define QCSAPI_WIFI_GET_RADIUS_ACCT_INTERIM_INTERVAL_REMOTE 7661
extern  enum clnt_stat qcsapi_wifi_get_radius_acct_interim_interval_remote_1(qcsapi_wifi_get_radius_acct_interim_interval_rpcdata *, qcsapi_wifi_get_radius_acct_interim_interval_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_get_radius_acct_interim_interval_remote_1_svc(qcsapi_wifi_get_radius_acct_interim_interval_rpcdata *, qcsapi_wifi_get_radius_acct_interim_interval_rpcdata *, struct svc_req *);
#define QCSAPI_WIFI_SET_RADIUS_ACCT_INTERIM_INTERVAL_REMOTE 7651
extern  enum clnt_stat qcsapi_wifi_set_radius_acct_interim_interval_remote_1(qcsapi_wifi_set_radius_acct_interim_interval_rpcdata *, qcsapi_wifi_set_radius_acct_interim_interval_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_set_radius_acct_interim_interval_remote_1_svc(qcsapi_wifi_set_radius_acct_interim_interval_rpcdata *, qcsapi_wifi_set_radius_acct_interim_interval_rpcdata *, struct svc_req *);
...
#define QCSAPI_WIFI_ADD_TEMPORARY_MAC_FILTER_ADDR_REMOTE 8751
extern  enum clnt_stat qcsapi_wifi_add_temporary_mac_filter_addr_remote_1(qcsapi_wifi_add_temporary_mac_filter_addr_rpcdata *, qcsapi_wifi_add_temporary_mac_filter_addr_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_add_temporary_mac_filter_addr_remote_1_svc(qcsapi_wifi_add_temporary_mac_filter_addr_rpcdata *, qcsapi_wifi_add_temporary_mac_filter_addr_rpcdata *, struct svc_req *);
#define QCSAPI_WIFI_DEL_TEMPORARY_MAC_FILTER_ADDR_REMOTE 8761
extern  enum clnt_stat qcsapi_wifi_del_temporary_mac_filter_addr_remote_1(qcsapi_wifi_del_temporary_mac_filter_addr_rpcdata *, qcsapi_wifi_del_temporary_mac_filter_addr_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_del_temporary_mac_filter_addr_remote_1_svc(qcsapi_wifi_del_temporary_mac_filter_addr_rpcdata *, qcsapi_wifi_del_temporary_mac_filter_addr_rpcdata *, struct svc_req *);
...
#define QCSAPI_WPS_CONFIGURE_AP_REMOTE 8861
extern  enum clnt_stat qcsapi_wps_configure_ap_remote_1(qcsapi_wps_configure_ap_rpcdata *, qcsapi_wps_configure_ap_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wps_configure_ap_remote_1_svc(qcsapi_wps_configure_ap_rpcdata *, qcsapi_wps_configure_ap_rpcdata *, struct svc_req *);
...
extern  enum clnt_stat qcsapi_wifi_get_results_ap_scan_by_scs_remote_1(qcsapi_wifi_get_results_AP_scan_by_scs_rpcdata *, qcsapi_wifi_get_results_AP_scan_by_scs_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_get_results_ap_scan_by_scs_remote_1_svc(qcsapi_wifi_get_results_AP_scan_by_scs_rpcdata *, qcsapi_wifi_get_results_AP_scan_by_scs_rpcdata *, struct svc_req *);
...
#define QCSAPI_WIFI_SET_RX_NSS_CAP_REMOTE 8981
extern  enum clnt_stat qcsapi_wifi_set_rx_nss_cap_remote_1(qcsapi_wifi_set_rx_nss_cap_rpcdata *, qcsapi_wifi_set_rx_nss_cap_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_set_rx_nss_cap_remote_1_svc(qcsapi_wifi_set_rx_nss_cap_rpcdata *, qcsapi_wifi_set_rx_nss_cap_rpcdata *, struct svc_req *);
#define QCSAPI_WIFI_GET_RX_NSS_CAP_REMOTE 8991
extern  enum clnt_stat qcsapi_wifi_get_rx_nss_cap_remote_1(qcsapi_wifi_get_rx_nss_cap_rpcdata *, qcsapi_wifi_get_rx_nss_cap_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_get_rx_nss_cap_remote_1_svc(qcsapi_wifi_get_rx_nss_cap_rpcdata *, qcsapi_wifi_get_rx_nss_cap_rpcdata *, struct svc_req *);
...
extern  enum clnt_stat qcsapi_wifi_set_ieee80211r_remote_1(qcsapi_wifi_set_ieee80211r_rpcdata *, qcsapi_wifi_set_ieee80211r_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_set_ieee80211r_remote_1_svc(qcsapi_wifi_set_ieee80211r_rpcdata *, qcsapi_wifi_set_ieee80211r_rpcdata *, struct svc_req *);
#define QCSAPI_WIFI_GET_IEEE80211R_REMOTE 7741
extern  enum clnt_stat qcsapi_wifi_get_ieee80211r_remote_1(qcsapi_wifi_get_ieee80211r_rpcdata *, qcsapi_wifi_get_ieee80211r_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_get_ieee80211r_remote_1_svc(qcsapi_wifi_get_ieee80211r_rpcdata *, qcsapi_wifi_get_ieee80211r_rpcdata *, struct svc_req *);
#define QCSAPI_WIFI_SET_IEEE80211R_MOBILITY_DOMAIN_REMOTE 7751
extern  enum clnt_stat qcsapi_wifi_set_ieee80211r_mobility_domain_remote_1(qcsapi_wifi_set_ieee80211r_mobility_domain_rpcdata *, qcsapi_wifi_set_ieee80211r_mobility_domain_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_set_ieee80211r_mobility_domain_remote_1_svc(qcsapi_wifi_set_ieee80211r_mobility_domain_rpcdata *, qcsapi_wifi_set_ieee80211r_mobility_domain_rpcdata *, struct svc_req *);
#define QCSAPI_WIFI_GET_IEEE80211R_MOBILITY_DOMAIN_REMOTE 7761
extern  enum clnt_stat qcsapi_wifi_get_ieee80211r_mobility_domain_remote_1(qcsapi_wifi_get_ieee80211r_mobility_domain_rpcdata *, qcsapi_wifi_get_ieee80211r_mobility_domain_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_get_ieee80211r_mobility_domain_remote_1_svc(qcsapi_wifi_get_ieee80211r_mobility_domain_rpcdata *, qcsapi_wifi_get_ieee80211r_mobility_domain_rpcdata *, struct svc_req *);
#define QCSAPI_WIFI_SET_IEEE80211R_NAS_ID_REMOTE 7771
extern  enum clnt_stat qcsapi_wifi_set_ieee80211r_nas_id_remote_1(qcsapi_wifi_set_ieee80211r_nas_id_rpcdata *, qcsapi_wifi_set_ieee80211r_nas_id_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_set_ieee80211r_nas_id_remote_1_svc(qcsapi_wifi_set_ieee80211r_nas_id_rpcdata *, qcsapi_wifi_set_ieee80211r_nas_id_rpcdata *, struct svc_req *);
#define QCSAPI_WIFI_GET_IEEE80211R_NAS_ID_REMOTE 7781
extern  enum clnt_stat qcsapi_wifi_get_ieee80211r_nas_id_remote_1(qcsapi_wifi_get_ieee80211r_nas_id_rpcdata *, qcsapi_wifi_get_ieee80211r_nas_id_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_get_ieee80211r_nas_id_remote_1_svc(qcsapi_wifi_get_ieee80211r_nas_id_rpcdata *, qcsapi_wifi_get_ieee80211r_nas_id_rpcdata *, struct svc_req *);
#define QCSAPI_WIFI_SET_IEEE80211R_FT_OVER_DS_REMOTE 7791
extern  enum clnt_stat qcsapi_wifi_set_ieee80211r_ft_over_ds_remote_1(qcsapi_wifi_set_ieee80211r_ft_over_ds_rpcdata *, qcsapi_wifi_set_ieee80211r_ft_over_ds_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_set_ieee80211r_ft_over_ds_remote_1_svc(qcsapi_wifi_set_ieee80211r_ft_over_ds_rpcdata *, qcsapi_wifi_set_ieee80211r_ft_over_ds_rpcdata *, struct svc_req *);
#define QCSAPI_WIFI_GET_IEEE80211R_FT_OVER_DS_REMOTE 7801
extern  enum clnt_stat qcsapi_wifi_get_ieee80211r_ft_over_ds_remote_1(qcsapi_wifi_get_ieee80211r_ft_over_ds_rpcdata *, qcsapi_wifi_get_ieee80211r_ft_over_ds_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_get_ieee80211r_ft_over_ds_remote_1_svc(qcsapi_wifi_get_ieee80211r_ft_over_ds_rpcdata *, qcsapi_wifi_get_ieee80211r_ft_over_ds_rpcdata *, struct svc_req *);
#define QCSAPI_WIFI_ADD_11R_NEIGHBOUR_REMOTE 8641
extern  enum clnt_stat qcsapi_wifi_add_11r_neighbour_remote_1(qcsapi_wifi_add_11r_neighbour_rpcdata *, qcsapi_wifi_add_11r_neighbour_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_add_11r_neighbour_remote_1_svc(qcsapi_wifi_add_11r_neighbour_rpcdata *, qcsapi_wifi_add_11r_neighbour_rpcdata *, struct svc_req *);
#define QCSAPI_WIFI_DEL_11R_NEIGHBOUR_REMOTE 8651
extern  enum clnt_stat qcsapi_wifi_del_11r_neighbour_remote_1(qcsapi_wifi_del_11r_neighbour_rpcdata *, qcsapi_wifi_del_11r_neighbour_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_del_11r_neighbour_remote_1_svc(qcsapi_wifi_del_11r_neighbour_rpcdata *, qcsapi_wifi_del_11r_neighbour_rpcdata *, struct svc_req *);
#define QCSAPI_WIFI_GET_11R_NEIGHBOUR_REMOTE 8661
extern  enum clnt_stat qcsapi_wifi_get_11r_neighbour_remote_1(qcsapi_wifi_get_11r_neighbour_rpcdata *, qcsapi_wifi_get_11r_neighbour_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_get_11r_neighbour_remote_1_svc(qcsapi_wifi_get_11r_neighbour_rpcdata *, qcsapi_wifi_get_11r_neighbour_rpcdata *, struct svc_req *);
#define QCSAPI_WIFI_SET_11R_R1_KEY_HOLDER_REMOTE 8671
extern  enum clnt_stat qcsapi_wifi_set_11r_r1_key_holder_remote_1(qcsapi_wifi_set_11r_r1_key_holder_rpcdata *, qcsapi_wifi_set_11r_r1_key_holder_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_set_11r_r1_key_holder_remote_1_svc(qcsapi_wifi_set_11r_r1_key_holder_rpcdata *, qcsapi_wifi_set_11r_r1_key_holder_rpcdata *, struct svc_req *);
#define QCSAPI_WIFI_GET_11R_R1_KEY_HOLDER_REMOTE 8681
extern  enum clnt_stat qcsapi_wifi_get_11r_r1_key_holder_remote_1(qcsapi_wifi_get_11r_r1_key_holder_rpcdata *, qcsapi_wifi_get_11r_r1_key_holder_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_get_11r_r1_key_holder_remote_1_svc(qcsapi_wifi_get_11r_r1_key_holder_rpcdata *, qcsapi_wifi_get_11r_r1_key_holder_rpcdata *, struct svc_req *);
#define QCSAPI_WIFI_GET_BTM_CAP_REMOTE 8601
extern  enum clnt_stat qcsapi_wifi_get_btm_cap_remote_1(qcsapi_wifi_get_btm_cap_rpcdata *, qcsapi_wifi_get_btm_cap_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_get_btm_cap_remote_1_svc(qcsapi_wifi_get_btm_cap_rpcdata *, qcsapi_wifi_get_btm_cap_rpcdata *, struct svc_req *);
#define QCSAPI_WIFI_SET_BTM_CAP_REMOTE 8611
extern  enum clnt_stat qcsapi_wifi_set_btm_cap_remote_1(qcsapi_wifi_set_btm_cap_rpcdata *, qcsapi_wifi_set_btm_cap_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_set_btm_cap_remote_1_svc(qcsapi_wifi_set_btm_cap_rpcdata *, qcsapi_wifi_set_btm_cap_rpcdata *, struct svc_req *);
#define QCSAPI_WIFI_GET_RM_NEIGH_REPORT_REMOTE 8631
extern  enum clnt_stat qcsapi_wifi_get_rm_neigh_report_remote_1(qcsapi_wifi_get_rm_neigh_report_rpcdata *, qcsapi_wifi_get_rm_neigh_report_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_get_rm_neigh_report_remote_1_svc(qcsapi_wifi_get_rm_neigh_report_rpcdata *, qcsapi_wifi_get_rm_neigh_report_rpcdata *, struct svc_req *);
#define QCSAPI_WIFI_SET_RM_NEIGH_REPORT_REMOTE 8621
extern  enum clnt_stat qcsapi_wifi_set_rm_neigh_report_remote_1(qcsapi_wifi_set_rm_neigh_report_rpcdata *, qcsapi_wifi_set_rm_neigh_report_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_set_rm_neigh_report_remote_1_svc(qcsapi_wifi_set_rm_neigh_report_rpcdata *, qcsapi_wifi_set_rm_neigh_report_rpcdata *, struct svc_req *);
#define QCSAPI_SET_UNKNOWN_DEST_DISCOVER_INTVAL_REMOTE 9001
extern  enum clnt_stat qcsapi_set_unknown_dest_discover_intval_remote_1(qcsapi_set_unknown_dest_discover_intval_rpcdata *, qcsapi_set_unknown_dest_discover_intval_rpcdata *, CLIENT *);
extern  bool_t qcsapi_set_unknown_dest_discover_intval_remote_1_svc(qcsapi_set_unknown_dest_discover_intval_rpcdata *, qcsapi_set_unknown_dest_discover_intval_rpcdata *, struct svc_req *);
#define QCSAPI_GET_UNKNOWN_DEST_DISCOVER_INTVAL_REMOTE 9011
extern  enum clnt_stat qcsapi_get_unknown_dest_discover_intval_remote_1(qcsapi_get_unknown_dest_discover_intval_rpcdata *, qcsapi_get_unknown_dest_discover_intval_rpcdata *, CLIENT *);
extern  bool_t qcsapi_get_unknown_dest_discover_intval_remote_1_svc(qcsapi_get_unknown_dest_discover_intval_rpcdata *, qcsapi_get_unknown_dest_discover_intval_rpcdata *, struct svc_req *);
...
#define QCSAPI_CALCMD_CHECK_RFIC_HEALTH_REMOTE 8771
extern  enum clnt_stat qcsapi_calcmd_check_rfic_health_remote_1(qcsapi_calcmd_check_rfic_health_rpcdata *, qcsapi_calcmd_check_rfic_health_rpcdata *, CLIENT *);
extern  bool_t qcsapi_calcmd_check_rfic_health_remote_1_svc(qcsapi_calcmd_check_rfic_health_rpcdata *, qcsapi_calcmd_check_rfic_health_rpcdata *, struct svc_req *);
...
#define QCSAPI_GET_APP_CORE_DUMP_EXT_REMOTE 6942
extern  enum clnt_stat qcsapi_get_app_core_dump_ext_remote_1(qcsapi_get_app_core_dump_ext_rpcdata *, qcsapi_get_app_core_dump_ext_rpcdata *, CLIENT *);
extern  bool_t qcsapi_get_app_core_dump_ext_remote_1_svc(qcsapi_get_app_core_dump_ext_rpcdata *, qcsapi_get_app_core_dump_ext_rpcdata *, struct svc_req *);
...
#define QCSAPI_WIFI_GET_VOPT_REMOTE 8763
extern  enum clnt_stat qcsapi_wifi_get_vopt_remote_1(qcsapi_wifi_get_vopt_rpcdata *, qcsapi_wifi_get_vopt_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_get_vopt_remote_1_svc(qcsapi_wifi_get_vopt_rpcdata *, qcsapi_wifi_get_vopt_rpcdata *, struct svc_req *);
#define QCSAPI_WIFI_SET_VOPT_REMOTE 8762
extern  enum clnt_stat qcsapi_wifi_set_vopt_remote_1(qcsapi_wifi_set_vopt_rpcdata *, qcsapi_wifi_set_vopt_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_set_vopt_remote_1_svc(qcsapi_wifi_set_vopt_rpcdata *, qcsapi_wifi_set_vopt_rpcdata *, struct svc_req *);
...
extern  enum clnt_stat qcsapi_wifi_set_nac_mon_mode_remote_1(qcsapi_wifi_set_nac_mon_mode_rpcdata *, qcsapi_wifi_set_nac_mon_mode_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_set_nac_mon_mode_remote_1_svc(qcsapi_wifi_set_nac_mon_mode_rpcdata *, qcsapi_wifi_set_nac_mon_mode_rpcdata *, struct svc_req *);
#define QCSAPI_WIFI_GET_NAC_MON_MODE_REMOTE 7261
extern  enum clnt_stat qcsapi_wifi_get_nac_mon_mode_remote_1(qcsapi_wifi_get_nac_mon_mode_rpcdata *, qcsapi_wifi_get_nac_mon_mode_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_get_nac_mon_mode_remote_1_svc(qcsapi_wifi_get_nac_mon_mode_rpcdata *, qcsapi_wifi_get_nac_mon_mode_rpcdata *, struct svc_req *);
#define QCSAPI_WIFI_GET_NAC_STATS_REMOTE 7271
extern  enum clnt_stat qcsapi_wifi_get_nac_stats_remote_1(qcsapi_wifi_get_nac_stats_rpcdata *, qcsapi_wifi_get_nac_stats_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_get_nac_stats_remote_1_svc(qcsapi_wifi_get_nac_stats_rpcdata *, qcsapi_wifi_get_nac_stats_rpcdata *, struct svc_req *);
#define QCSAPI_SET_REPORT_FLOOD_INTERVAL_REMOTE 8571
extern  enum clnt_stat qcsapi_set_report_flood_interval_remote_1(qcsapi_set_report_flood_interval_rpcdata *, qcsapi_set_report_flood_interval_rpcdata *, CLIENT *);
extern  bool_t qcsapi_set_report_flood_interval_remote_1_svc(qcsapi_set_report_flood_interval_rpcdata *, qcsapi_set_report_flood_interval_rpcdata *, struct svc_req *);
#define QCSAPI_GET_REPORT_FLOOD_INTERVAL_REMOTE 8581
extern  enum clnt_stat qcsapi_get_report_flood_interval_remote_1(qcsapi_get_report_flood_interval_rpcdata *, qcsapi_get_report_flood_interval_rpcdata *, CLIENT *);
extern  bool_t qcsapi_get_report_flood_interval_remote_1_svc(qcsapi_get_report_flood_interval_rpcdata *, qcsapi_get_report_flood_interval_rpcdata *, struct svc_req *);
#define QCSAPI_GET_PD_VOLTAGE_LEVEL_REMOTE 8701
extern  enum clnt_stat qcsapi_get_pd_voltage_level_remote_1(qcsapi_get_pd_voltage_level_rpcdata *, qcsapi_get_pd_voltage_level_rpcdata *, CLIENT *);
extern  bool_t qcsapi_get_pd_voltage_level_remote_1_svc(qcsapi_get_pd_voltage_level_rpcdata *, qcsapi_get_pd_voltage_level_rpcdata *, struct svc_req *);
#define QCSAPI_WIFI_RELOAD_SECURITY_CONFIG_REMOTE 8781
extern  enum clnt_stat qcsapi_wifi_reload_security_config_remote_1(qcsapi_wifi_reload_security_config_rpcdata *, qcsapi_wifi_reload_security_config_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_reload_security_config_remote_1_svc(qcsapi_wifi_reload_security_config_rpcdata *, qcsapi_wifi_reload_security_config_rpcdata *, struct svc_req *);
#define QCSAPI_ENABLE_EMAC_SDP_REMOTE 8901
extern  enum clnt_stat qcsapi_enable_emac_sdp_remote_1(qcsapi_enable_emac_sdp_rpcdata *, qcsapi_enable_emac_sdp_rpcdata *, CLIENT *);
extern  bool_t qcsapi_enable_emac_sdp_remote_1_svc(qcsapi_enable_emac_sdp_rpcdata *, qcsapi_enable_emac_sdp_rpcdata *, struct svc_req *);
#define QCSAPI_WIFI_SET_BSS_RXSCAN_REMOTE 8931
extern  enum clnt_stat qcsapi_wifi_set_bss_rxscan_remote_1(qcsapi_wifi_set_bss_rxscan_rpcdata *, qcsapi_wifi_set_bss_rxscan_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_set_bss_rxscan_remote_1_svc(qcsapi_wifi_set_bss_rxscan_rpcdata *, qcsapi_wifi_set_bss_rxscan_rpcdata *, struct svc_req *);
#define QCSAPI_RADIO_SET_3ADDR_BR_CONFIG_REMOTE 9081
extern  enum clnt_stat qcsapi_radio_set_3addr_br_config_remote_1(qcsapi_radio_set_3addr_br_config_rpcdata *, qcsapi_radio_set_3addr_br_config_rpcdata *, CLIENT *);
extern  bool_t qcsapi_radio_set_3addr_br_config_remote_1_svc(qcsapi_radio_set_3addr_br_config_rpcdata *, qcsapi_radio_set_3addr_br_config_rpcdata *, struct svc_req *);
#define QCSAPI_RADIO_GET_3ADDR_BR_CONFIG_REMOTE 9091
extern  enum clnt_stat qcsapi_radio_get_3addr_br_config_remote_1(qcsapi_radio_get_3addr_br_config_rpcdata *, qcsapi_radio_get_3addr_br_config_rpcdata *, CLIENT *);
extern  bool_t qcsapi_radio_get_3addr_br_config_remote_1_svc(qcsapi_radio_get_3addr_br_config_rpcdata *, qcsapi_radio_get_3addr_br_config_rpcdata *, struct svc_req *);
...
#define QCSAPI_GET_QFDR_PARAMETER_REMOTE 7071
extern  enum clnt_stat qcsapi_get_qfdr_parameter_remote_1();
extern  bool_t qcsapi_get_qfdr_parameter_remote_1_svc();
#define QCSAPI_SET_QFDR_PARAMETER_REMOTE 7081
extern  enum clnt_stat qcsapi_set_qfdr_parameter_remote_1();
extern  bool_t qcsapi_set_qfdr_parameter_remote_1_svc();
#define QCSAPI_GET_QFDR_STATE_REMOTE 8941
extern  enum clnt_stat qcsapi_get_qfdr_state_remote_1();
extern  bool_t qcsapi_get_qfdr_state_remote_1_svc();
#define QCSAPI_TELNET_ENABLE_REMOTE 31
...
#define QCSAPI_WIFI_SET_SCS_ACTIVE_CHAN_LIST_REMOTE 8881
extern  enum clnt_stat qcsapi_wifi_set_scs_active_chan_list_remote_1();
extern  bool_t qcsapi_wifi_set_scs_active_chan_list_remote_1_svc();
#define QCSAPI_WIFI_GET_SCS_ACTIVE_CHAN_LIST_REMOTE 8891
extern  enum clnt_stat qcsapi_wifi_get_scs_active_chan_list_remote_1();
extern  bool_t qcsapi_wifi_get_scs_active_chan_list_remote_1_svc();
#define QCSAPI_WIFI_SET_SCS_SMPL_DWELL_TIME_REMOTE 101
...
#define QCSAPI_WIFI_SET_SCS_SAMPLE_TYPE_REMOTE 232
extern  enum clnt_stat qcsapi_wifi_set_scs_sample_type_remote_1();
extern  bool_t qcsapi_wifi_set_scs_sample_type_remote_1_svc();
#define QCSAPI_WIFI_SET_SCS_INTF_DETECT_INTV_REMOTE 121
...
#define QCSAPI_WIFI_GET_SCS_INTERFERENCE_REPORT_REMOTE 153
extern  enum clnt_stat qcsapi_wifi_get_scs_interference_report_remote_1();
extern  bool_t qcsapi_wifi_get_scs_interference_report_remote_1_svc();
#define QCSAPI_WIFI_GET_SCS_SCORE_REPORT_REMOTE 152
...
#define QCSAPI_WIFI_SET_SCS_NAC_MONITOR_MODE_REMOTE 202
extern  enum clnt_stat qcsapi_wifi_set_scs_nac_monitor_mode_remote_1();
extern  bool_t qcsapi_wifi_set_scs_nac_monitor_mode_remote_1_svc();
#define QCSAPI_WIFI_GET_SCS_CCA_INTF_REMOTE 211
...
#define QCSAPI_WIFI_SET_SCS_BURST_ENABLE_REMOTE 233
extern  enum clnt_stat qcsapi_wifi_set_scs_burst_enable_remote_1();
extern  bool_t qcsapi_wifi_set_scs_burst_enable_remote_1_svc();
#define QCSAPI_WIFI_SET_SCS_BURST_WINDOW_REMOTE 234
extern  enum clnt_stat qcsapi_wifi_set_scs_burst_window_remote_1();
extern  bool_t qcsapi_wifi_set_scs_burst_window_remote_1_svc();
#define QCSAPI_WIFI_SET_SCS_BURST_THRESH_REMOTE 235
extern  enum clnt_stat qcsapi_wifi_set_scs_burst_thresh_remote_1();
extern  bool_t qcsapi_wifi_set_scs_burst_thresh_remote_1_svc();
#define QCSAPI_WIFI_SET_SCS_BURST_PAUSE_REMOTE 236
extern  enum clnt_stat qcsapi_wifi_set_scs_burst_pause_remote_1();
extern  bool_t qcsapi_wifi_set_scs_burst_pause_remote_1_svc();
#define QCSAPI_WIFI_SET_SCS_BURST_SWITCH_REMOTE 237
extern  enum clnt_stat qcsapi_wifi_set_scs_burst_switch_remote_1();
extern  bool_t qcsapi_wifi_set_scs_burst_switch_remote_1_svc();
#define QCSAPI_WIFI_START_OCAC_REMOTE 241
...
#define QCSAPI_WIFI_GET_ICAC_STATUS_REMOTE 8871
extern  enum clnt_stat qcsapi_wifi_get_icac_status_remote_1();
extern  bool_t qcsapi_wifi_get_icac_status_remote_1_svc();
#define QCSAPI_INIT_REMOTE 321
...
#define QCSAPI_GET_DEVICE_MODE_REMOTE 7241
extern  enum clnt_stat qcsapi_get_device_mode_remote_1();
extern  bool_t qcsapi_get_device_mode_remote_1_svc();
#define QCSAPI_CONFIG_GET_PARAMETER_REMOTE 361
...
#define QCSAPI_GET_STORED_IPADDR_REMOTE 8691
extern  enum clnt_stat qcsapi_get_stored_ipaddr_remote_1();
extern  bool_t qcsapi_get_stored_ipaddr_remote_1_svc();
#define QCSAPI_INTERFACE_ENABLE_REMOTE 441
...
#define QCSAPI_WIFI_GET_CHAN_USABLE_REMOTE 7051
extern  enum clnt_stat qcsapi_wifi_get_chan_usable_remote_1();
extern  bool_t qcsapi_wifi_get_chan_usable_remote_1_svc();
#define QCSAPI_WIFI_GET_SUPPORTED_FREQ_BANDS_REMOTE 6291
...
#define QCSAPI_WIFI_ASSOCIATE_NOSCAN_REMOTE 872
extern  enum clnt_stat qcsapi_wifi_associate_noscan_remote_1();
extern  bool_t qcsapi_wifi_associate_noscan_remote_1_svc();
#define QCSAPI_WIFI_START_CCA_REMOTE 881
...
#define QCSAPI_WIFI_GET_AC_AGG_HOLD_TIME_REMOTE 8821
extern  enum clnt_stat qcsapi_wifi_get_ac_agg_hold_time_remote_1();
extern  bool_t qcsapi_wifi_get_ac_agg_hold_time_remote_1_svc();
#define QCSAPI_WIFI_SET_AC_AGG_HOLD_TIME_REMOTE 8831
extern  enum clnt_stat qcsapi_wifi_set_ac_agg_hold_time_remote_1();
extern  bool_t qcsapi_wifi_set_ac_agg_hold_time_remote_1_svc();
#define QCSAPI_WIFI_SET_QOS_MAP_REMOTE 6441
...
#define QCSAPI_WIFI_WDS_SET_PSK_REMOTE 7711
extern  enum clnt_stat qcsapi_wifi_wds_set_psk_remote_1();
extern  bool_t qcsapi_wifi_wds_set_psk_remote_1_svc();
#define QCSAPI_WDS_SET_MODE_REMOTE 1521
...
#define QCSAPI_WIFI_SET_AUTOCHAN_PARAMS_REMOTE 7681
extern  enum clnt_stat qcsapi_wifi_set_autochan_params_remote_1();
extern  bool_t qcsapi_wifi_set_autochan_params_remote_1_svc();
#define QCSAPI_WIFI_GET_AUTOCHAN_PARAMS_REMOTE 7671
extern  enum clnt_stat qcsapi_wifi_get_autochan_params_remote_1();
extern  bool_t qcsapi_wifi_get_autochan_params_remote_1_svc();
#define QCSAPI_WIFI_UPDATE_AUTOCHAN_PARAMS_REMOTE 7691
extern  enum clnt_stat qcsapi_wifi_update_autochan_params_remote_1();
extern  bool_t qcsapi_wifi_update_autochan_params_remote_1_svc();
#define QCSAPI_WIFI_WDS_GET_PSK_REMOTE 7701
extern  enum clnt_stat qcsapi_wifi_wds_get_psk_remote_1();
extern  bool_t qcsapi_wifi_wds_get_psk_remote_1_svc();
#define QCSAPI_WIFI_GET_BEACON_TYPE_REMOTE 1581
...
#define QCSAPI_WIFI_SET_EAP_OWN_IP_ADDR_REMOTE 1882
extern  enum clnt_stat qcsapi_wifi_set_eap_own_ip_addr_remote_1();
extern  bool_t qcsapi_wifi_set_eap_own_ip_addr_remote_1_svc();
#define QCSAPI_WIFI_GET_EAP_OWN_IP_ADDR_REMOTE 1883
extern  enum clnt_stat qcsapi_wifi_get_eap_own_ip_addr_remote_1();
extern  bool_t qcsapi_wifi_get_eap_own_ip_addr_remote_1_svc();
#define QCSAPI_WIFI_GET_KEY_PASSPHRASE_REMOTE 1891
...
#define QCSAPI_WIFI_GET_RADIUS_ACCT_INTERIM_INTERVAL_REMOTE 7661
extern  enum clnt_stat qcsapi_wifi_get_radius_acct_interim_interval_remote_1();
extern  bool_t qcsapi_wifi_get_radius_acct_interim_interval_remote_1_svc();
#define QCSAPI_WIFI_SET_RADIUS_ACCT_INTERIM_INTERVAL_REMOTE 7651
extern  enum clnt_stat qcsapi_wifi_set_radius_acct_interim_interval_remote_1();
extern  bool_t qcsapi_wifi_set_radius_acct_interim_interval_remote_1_svc();
#define QCSAPI_WIFI_SET_MAC_ADDRESS_FILTERING_REMOTE 2011
...
#define QCSAPI_WIFI_ADD_TEMPORARY_MAC_FILTER_ADDR_REMOTE 8751
extern  enum clnt_stat qcsapi_wifi_add_temporary_mac_filter_addr_remote_1();
extern  bool_t qcsapi_wifi_add_temporary_mac_filter_addr_remote_1_svc();
#define QCSAPI_WIFI_DEL_TEMPORARY_MAC_FILTER_ADDR_REMOTE 8761
extern  enum clnt_stat qcsapi_wifi_del_temporary_mac_filter_addr_remote_1();
extern  bool_t qcsapi_wifi_del_temporary_mac_filter_addr_remote_1_svc();
#define QCSAPI_WIFI_AUTHORIZE_MAC_ADDRESS_LIST_EXT_REMOTE 6881
...
#define QCSAPI_WPS_CONFIGURE_AP_REMOTE 8861
extern  enum clnt_stat qcsapi_wps_configure_ap_remote_1();
extern  bool_t qcsapi_wps_configure_ap_remote_1_svc();
#define QCSAPI_WPS_SAVE_AP_PIN_REMOTE 2481
...
#define QCSAPI_WIFI_GET_RESULTS_AP_SCAN_BY_SCS_REMOTE 238
extern  enum clnt_stat qcsapi_wifi_get_results_ap_scan_by_scs_remote_1();
extern  bool_t qcsapi_wifi_get_results_ap_scan_by_scs_remote_1_svc();
#define QCSAPI_WIFI_GET_COUNT_APS_SCANNED_REMOTE 3381
...
#define QCSAPI_WIFI_SET_RX_NSS_CAP_REMOTE 8981
extern  enum clnt_stat qcsapi_wifi_set_rx_nss_cap_remote_1();
extern  bool_t qcsapi_wifi_set_rx_nss_cap_remote_1_svc();
#define QCSAPI_WIFI_GET_RX_NSS_CAP_REMOTE 8991
extern  enum clnt_stat qcsapi_wifi_get_rx_nss_cap_remote_1();
extern  bool_t qcsapi_wifi_get_rx_nss_cap_remote_1_svc();
#define QCSAPI_WIFI_GET_TX_AMSDU_REMOTE 4171
...
#define QCSAPI_WIFI_SET_IEEE80211R_REMOTE 7731
extern  enum clnt_stat qcsapi_wifi_set_ieee80211r_remote_1();
extern  bool_t qcsapi_wifi_set_ieee80211r_remote_1_svc();
#define QCSAPI_WIFI_GET_IEEE80211R_REMOTE 7741
extern  enum clnt_stat qcsapi_wifi_get_ieee80211r_remote_1();
extern  bool_t qcsapi_wifi_get_ieee80211r_remote_1_svc();
#define QCSAPI_WIFI_SET_IEEE80211R_MOBILITY_DOMAIN_REMOTE 7751
extern  enum clnt_stat qcsapi_wifi_set_ieee80211r_mobility_domain_remote_1();
extern  bool_t qcsapi_wifi_set_ieee80211r_mobility_domain_remote_1_svc();
#define QCSAPI_WIFI_GET_IEEE80211R_MOBILITY_DOMAIN_REMOTE 7761
extern  enum clnt_stat qcsapi_wifi_get_ieee80211r_mobility_domain_remote_1();
extern  bool_t qcsapi_wifi_get_ieee80211r_mobility_domain_remote_1_svc();
#define QCSAPI_WIFI_SET_IEEE80211R_NAS_ID_REMOTE 7771
extern  enum clnt_stat qcsapi_wifi_set_ieee80211r_nas_id_remote_1();
extern  bool_t qcsapi_wifi_set_ieee80211r_nas_id_remote_1_svc();
#define QCSAPI_WIFI_GET_IEEE80211R_NAS_ID_REMOTE 7781
extern  enum clnt_stat qcsapi_wifi_get_ieee80211r_nas_id_remote_1();
extern  bool_t qcsapi_wifi_get_ieee80211r_nas_id_remote_1_svc();
#define QCSAPI_WIFI_SET_IEEE80211R_FT_OVER_DS_REMOTE 7791
extern  enum clnt_stat qcsapi_wifi_set_ieee80211r_ft_over_ds_remote_1();
extern  bool_t qcsapi_wifi_set_ieee80211r_ft_over_ds_remote_1_svc();
#define QCSAPI_WIFI_GET_IEEE80211R_FT_OVER_DS_REMOTE 7801
extern  enum clnt_stat qcsapi_wifi_get_ieee80211r_ft_over_ds_remote_1();
extern  bool_t qcsapi_wifi_get_ieee80211r_ft_over_ds_remote_1_svc();
#define QCSAPI_WIFI_ADD_11R_NEIGHBOUR_REMOTE 8641
extern  enum clnt_stat qcsapi_wifi_add_11r_neighbour_remote_1();
extern  bool_t qcsapi_wifi_add_11r_neighbour_remote_1_svc();
#define QCSAPI_WIFI_DEL_11R_NEIGHBOUR_REMOTE 8651
extern  enum clnt_stat qcsapi_wifi_del_11r_neighbour_remote_1();
extern  bool_t qcsapi_wifi_del_11r_neighbour_remote_1_svc();
#define QCSAPI_WIFI_GET_11R_NEIGHBOUR_REMOTE 8661
extern  enum clnt_stat qcsapi_wifi_get_11r_neighbour_remote_1();
extern  bool_t qcsapi_wifi_get_11r_neighbour_remote_1_svc();
#define QCSAPI_WIFI_SET_11R_R1_KEY_HOLDER_REMOTE 8671
extern  enum clnt_stat qcsapi_wifi_set_11r_r1_key_holder_remote_1();
extern  bool_t qcsapi_wifi_set_11r_r1_key_holder_remote_1_svc();
#define QCSAPI_WIFI_GET_11R_R1_KEY_HOLDER_REMOTE 8681
extern  enum clnt_stat qcsapi_wifi_get_11r_r1_key_holder_remote_1();
extern  bool_t qcsapi_wifi_get_11r_r1_key_holder_remote_1_svc();
#define QCSAPI_WIFI_GET_BTM_CAP_REMOTE 8601
extern  enum clnt_stat qcsapi_wifi_get_btm_cap_remote_1();
extern  bool_t qcsapi_wifi_get_btm_cap_remote_1_svc();
#define QCSAPI_WIFI_SET_BTM_CAP_REMOTE 8611
extern  enum clnt_stat qcsapi_wifi_set_btm_cap_remote_1();
extern  bool_t qcsapi_wifi_set_btm_cap_remote_1_svc();
#define QCSAPI_WIFI_GET_RM_NEIGH_REPORT_REMOTE 8631
extern  enum clnt_stat qcsapi_wifi_get_rm_neigh_report_remote_1();
extern  bool_t qcsapi_wifi_get_rm_neigh_report_remote_1_svc();
#define QCSAPI_WIFI_SET_RM_NEIGH_REPORT_REMOTE 8621
extern  enum clnt_stat qcsapi_wifi_set_rm_neigh_report_remote_1();
extern  bool_t qcsapi_wifi_set_rm_neigh_report_remote_1_svc();
#define QCSAPI_SET_UNKNOWN_DEST_DISCOVER_INTVAL_REMOTE 9001
extern  enum clnt_stat qcsapi_set_unknown_dest_discover_intval_remote_1();
extern  bool_t qcsapi_set_unknown_dest_discover_intval_remote_1_svc();
#define QCSAPI_GET_UNKNOWN_DEST_DISCOVER_INTVAL_REMOTE 9011
extern  enum clnt_stat qcsapi_get_unknown_dest_discover_intval_remote_1();
extern  bool_t qcsapi_get_unknown_dest_discover_intval_remote_1_svc();
#define QCSAPI_GET_TEMPERATURE_INFO_REMOTE 3892
...
#define QCSAPI_CALCMD_CHECK_RFIC_HEALTH_REMOTE 8771
extern  enum clnt_stat qcsapi_calcmd_check_rfic_health_remote_1();
extern  bool_t qcsapi_calcmd_check_rfic_health_remote_1_svc();
#define QCSAPI_CALCMD_SHOW_TEST_PACKET_REMOTE 3911
...
#define QCSAPI_GET_APP_CORE_DUMP_EXT_REMOTE 6942
extern  enum clnt_stat qcsapi_get_app_core_dump_ext_remote_1();
extern  bool_t qcsapi_get_app_core_dump_ext_remote_1_svc();
#define QCSAPI_SET_LOG_LEVEL_REMOTE 6911
...
#define QCSAPI_WIFI_GET_VOPT_REMOTE 8763
extern  enum clnt_stat qcsapi_wifi_get_vopt_remote_1();
extern  bool_t qcsapi_wifi_get_vopt_remote_1_svc();
#define QCSAPI_WIFI_SET_VOPT_REMOTE 8762
extern  enum clnt_stat qcsapi_wifi_set_vopt_remote_1();
extern  bool_t qcsapi_wifi_set_vopt_remote_1_svc();
#define QCSAPI_WIFI_SET_BR_ISOLATE_REMOTE 7031
...
#define QCSAPI_WIFI_SET_NAC_MON_MODE_REMOTE 7251
extern  enum clnt_stat qcsapi_wifi_set_nac_mon_mode_remote_1();
extern  bool_t qcsapi_wifi_set_nac_mon_mode_remote_1_svc();
#define QCSAPI_WIFI_GET_NAC_MON_MODE_REMOTE 7261
extern  enum clnt_stat qcsapi_wifi_get_nac_mon_mode_remote_1();
extern  bool_t qcsapi_wifi_get_nac_mon_mode_remote_1_svc();
#define QCSAPI_WIFI_GET_NAC_STATS_REMOTE 7271
extern  enum clnt_stat qcsapi_wifi_get_nac_stats_remote_1();
extern  bool_t qcsapi_wifi_get_nac_stats_remote_1_svc();
#define QCSAPI_SET_REPORT_FLOOD_INTERVAL_REMOTE 8571
extern  enum clnt_stat qcsapi_set_report_flood_interval_remote_1();
extern  bool_t qcsapi_set_report_flood_interval_remote_1_svc();
#define QCSAPI_GET_REPORT_FLOOD_INTERVAL_REMOTE 8581
extern  enum clnt_stat qcsapi_get_report_flood_interval_remote_1();
extern  bool_t qcsapi_get_report_flood_interval_remote_1_svc();
#define QCSAPI_GET_PD_VOLTAGE_LEVEL_REMOTE 8701
extern  enum clnt_stat qcsapi_get_pd_voltage_level_remote_1();
extern  bool_t qcsapi_get_pd_voltage_level_remote_1_svc();
#define QCSAPI_WIFI_RELOAD_SECURITY_CONFIG_REMOTE 8781
extern  enum clnt_stat qcsapi_wifi_reload_security_config_remote_1();
extern  bool_t qcsapi_wifi_reload_security_config_remote_1_svc();
#define QCSAPI_ENABLE_EMAC_SDP_REMOTE 8901
extern  enum clnt_stat qcsapi_enable_emac_sdp_remote_1();
extern  bool_t qcsapi_enable_emac_sdp_remote_1_svc();
#define QCSAPI_WIFI_SET_BSS_RXSCAN_REMOTE 8931
extern  enum clnt_stat qcsapi_wifi_set_bss_rxscan_remote_1();
extern  bool_t qcsapi_wifi_set_bss_rxscan_remote_1_svc();
#define QCSAPI_RADIO_SET_3ADDR_BR_CONFIG_REMOTE 9081
extern  enum clnt_stat qcsapi_radio_set_3addr_br_config_remote_1();
extern  bool_t qcsapi_radio_set_3addr_br_config_remote_1_svc();
#define QCSAPI_RADIO_GET_3ADDR_BR_CONFIG_REMOTE 9091
extern  enum clnt_stat qcsapi_radio_get_3addr_br_config_remote_1();
extern  bool_t qcsapi_radio_get_3addr_br_config_remote_1_svc();
...
extern  bool_t xdr_qcsapi_get_qfdr_parameter_rpcdata (XDR *, qcsapi_get_qfdr_parameter_rpcdata*);
extern  bool_t xdr_qcsapi_set_qfdr_parameter_rpcdata (XDR *, qcsapi_set_qfdr_parameter_rpcdata*);
extern  bool_t xdr_qcsapi_get_qfdr_state_rpcdata (XDR *, qcsapi_get_qfdr_state_rpcdata*);
...
extern  bool_t xdr_qcsapi_get_device_mode_rpcdata (XDR *, qcsapi_get_device_mode_rpcdata*);
...
extern  bool_t xdr_qcsapi_get_stored_ipaddr_rpcdata (XDR *, qcsapi_get_stored_ipaddr_rpcdata*);
...
extern  bool_t xdr_qcsapi_wifi_associate_noscan_rpcdata (XDR *, qcsapi_wifi_associate_noscan_rpcdata*);
...
extern  bool_t xdr_qcsapi_wifi_set_autochan_params_rpcdata (XDR *, qcsapi_wifi_set_autochan_params_rpcdata*);
extern  bool_t xdr_qcsapi_wifi_get_autochan_params_rpcdata (XDR *, qcsapi_wifi_get_autochan_params_rpcdata*);
extern  bool_t xdr_qcsapi_wifi_update_autochan_params_rpcdata (XDR *, qcsapi_wifi_update_autochan_params_rpcdata*);
extern  bool_t xdr_qcsapi_wifi_wds_get_psk_rpcdata (XDR *, qcsapi_wifi_wds_get_psk_rpcdata*);
...
extern  bool_t xdr_qcsapi_wifi_set_eap_own_ip_addr_rpcdata (XDR *, qcsapi_wifi_set_eap_own_ip_addr_rpcdata*);
extern  bool_t xdr_qcsapi_wifi_get_eap_own_ip_addr_rpcdata (XDR *, qcsapi_wifi_get_eap_own_ip_addr_rpcdata*);
...
extern  bool_t xdr_qcsapi_wifi_get_radius_acct_interim_interval_rpcdata (XDR *, qcsapi_wifi_get_radius_acct_interim_interval_rpcdata*);
extern  bool_t xdr_qcsapi_wifi_set_radius_acct_interim_interval_rpcdata (XDR *, qcsapi_wifi_set_radius_acct_interim_interval_rpcdata*);
...
extern  bool_t xdr_qcsapi_wifi_add_temporary_mac_filter_addr_rpcdata (XDR *, qcsapi_wifi_add_temporary_mac_filter_addr_rpcdata*);
extern  bool_t xdr_qcsapi_wifi_del_temporary_mac_filter_addr_rpcdata (XDR *, qcsapi_wifi_del_temporary_mac_filter_addr_rpcdata*);
...
extern  bool_t xdr_qcsapi_wps_configure_ap_rpcdata (XDR *, qcsapi_wps_configure_ap_rpcdata*);
...
extern  bool_t xdr_qcsapi_wifi_set_rx_nss_cap_rpcdata (XDR *, qcsapi_wifi_set_rx_nss_cap_rpcdata*);
extern  bool_t xdr_qcsapi_wifi_get_rx_nss_cap_rpcdata (XDR *, qcsapi_wifi_get_rx_nss_cap_rpcdata*);
...
extern  bool_t xdr_qcsapi_wifi_get_btm_cap_rpcdata (XDR *, qcsapi_wifi_get_btm_cap_rpcdata*);
extern  bool_t xdr_qcsapi_wifi_set_btm_cap_rpcdata (XDR *, qcsapi_wifi_set_btm_cap_rpcdata*);
extern  bool_t xdr_qcsapi_wifi_get_rm_neigh_report_rpcdata (XDR *, qcsapi_wifi_get_rm_neigh_report_rpcdata*);
extern  bool_t xdr_qcsapi_wifi_set_rm_neigh_report_rpcdata (XDR *, qcsapi_wifi_set_rm_neigh_report_rpcdata*);
extern  bool_t xdr_qcsapi_set_unknown_dest_discover_intval_rpcdata (XDR *, qcsapi_set_unknown_dest_discover_intval_rpcdata*);
extern  bool_t xdr_qcsapi_get_unknown_dest_discover_intval_rpcdata (XDR *, qcsapi_get_unknown_dest_discover_intval_rpcdata*);
...
extern  bool_t xdr_qcsapi_calcmd_check_rfic_health_rpcdata (XDR *, qcsapi_calcmd_check_rfic_health_rpcdata*);
...
extern  bool_t xdr_qcsapi_get_app_core_dump_ext_rpcdata (XDR *, qcsapi_get_app_core_dump_ext_rpcdata*);
...
extern  bool_t xdr_qcsapi_wifi_get_vopt_rpcdata (XDR *, qcsapi_wifi_get_vopt_rpcdata*);
extern  bool_t xdr_qcsapi_wifi_set_vopt_rpcdata (XDR *, qcsapi_wifi_set_vopt_rpcdata*);
...
extern  bool_t xdr_qcsapi_set_report_flood_interval_rpcdata (XDR *, qcsapi_set_report_flood_interval_rpcdata*);
extern  bool_t xdr_qcsapi_get_report_flood_interval_rpcdata (XDR *, qcsapi_get_report_flood_interval_rpcdata*);
extern  bool_t xdr_qcsapi_get_pd_voltage_level_rpcdata (XDR *, qcsapi_get_pd_voltage_level_rpcdata*);
extern  bool_t xdr_qcsapi_wifi_reload_security_config_rpcdata (XDR *, qcsapi_wifi_reload_security_config_rpcdata*);
extern  bool_t xdr_qcsapi_enable_emac_sdp_rpcdata (XDR *, qcsapi_enable_emac_sdp_rpcdata*);
extern  bool_t xdr_qcsapi_wifi_set_bss_rxscan_rpcdata (XDR *, qcsapi_wifi_set_bss_rxscan_rpcdata*);
...
extern bool_t xdr_qcsapi_get_qfdr_parameter_rpcdata ();
extern bool_t xdr_qcsapi_set_qfdr_parameter_rpcdata ();
extern bool_t xdr_qcsapi_get_qfdr_state_rpcdata ();
...
extern bool_t xdr_qcsapi_get_device_mode_rpcdata ();
...
extern bool_t xdr_qcsapi_get_stored_ipaddr_rpcdata ();
...
extern bool_t xdr_qcsapi_wifi_associate_noscan_rpcdata ();
...
extern bool_t xdr_qcsapi_wifi_set_autochan_params_rpcdata ();
extern bool_t xdr_qcsapi_wifi_get_autochan_params_rpcdata ();
extern bool_t xdr_qcsapi_wifi_update_autochan_params_rpcdata ();
extern bool_t xdr_qcsapi_wifi_wds_get_psk_rpcdata ();
...
extern bool_t xdr_qcsapi_wifi_set_eap_own_ip_addr_rpcdata ();
extern bool_t xdr_qcsapi_wifi_get_eap_own_ip_addr_rpcdata ();
...
extern bool_t xdr_qcsapi_wifi_get_radius_acct_interim_interval_rpcdata ();
extern bool_t xdr_qcsapi_wifi_set_radius_acct_interim_interval_rpcdata ();
...
extern bool_t xdr_qcsapi_wifi_add_temporary_mac_filter_addr_rpcdata ();
extern bool_t xdr_qcsapi_wifi_del_temporary_mac_filter_addr_rpcdata ();
...
extern bool_t xdr_qcsapi_wps_configure_ap_rpcdata ();
...
extern bool_t xdr_qcsapi_wifi_set_rx_nss_cap_rpcdata ();
extern bool_t xdr_qcsapi_wifi_get_rx_nss_cap_rpcdata ();
...
extern bool_t xdr_qcsapi_wifi_get_btm_cap_rpcdata ();
extern bool_t xdr_qcsapi_wifi_set_btm_cap_rpcdata ();
extern bool_t xdr_qcsapi_wifi_get_rm_neigh_report_rpcdata ();
extern bool_t xdr_qcsapi_wifi_set_rm_neigh_report_rpcdata ();
extern bool_t xdr_qcsapi_set_unknown_dest_discover_intval_rpcdata ();
extern bool_t xdr_qcsapi_get_unknown_dest_discover_intval_rpcdata ();
extern bool_t xdr_qcsapi_get_temperature_info_rpcdata ();
extern bool_t xdr_qcsapi_calcmd_set_test_mode_rpcdata ();
extern bool_t xdr_qcsapi_calcmd_check_rfic_health_rpcdata ();
...
extern bool_t xdr_qcsapi_get_app_core_dump_ext_rpcdata ();
...
extern bool_t xdr_qcsapi_wifi_get_vopt_rpcdata ();
extern bool_t xdr_qcsapi_wifi_set_vopt_rpcdata ();
...
extern bool_t xdr_qcsapi_set_report_flood_interval_rpcdata ();
extern bool_t xdr_qcsapi_get_report_flood_interval_rpcdata ();
extern bool_t xdr_qcsapi_get_pd_voltage_level_rpcdata ();
extern bool_t xdr_qcsapi_wifi_reload_security_config_rpcdata ();
extern bool_t xdr_qcsapi_enable_emac_sdp_rpcdata ();
extern bool_t xdr_qcsapi_wifi_set_bss_rxscan_rpcdata ();
