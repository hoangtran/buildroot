...
bool_t
xdr_qcsapi_get_qfdr_parameter_rpcdata (XDR *xdrs, qcsapi_get_qfdr_parameter_rpcdata *objp)
{
	register int32_t *buf;
...
bool_t
xdr_qcsapi_set_qfdr_parameter_rpcdata (XDR *xdrs, qcsapi_set_qfdr_parameter_rpcdata *objp)
{
	register int32_t *buf;
...
bool_t
xdr_qcsapi_get_qfdr_state_rpcdata (XDR *xdrs, qcsapi_get_qfdr_state_rpcdata *objp)
{
	register int32_t *buf;

	 if (!xdr_pointer (xdrs, (char **)&objp->ifname, sizeof (__rpc_string), (xdrproc_t) xdr___rpc_string))
		 return FALSE;
	 if (!xdr_pointer (xdrs, (char **)&objp->state, sizeof (int), (xdrproc_t) xdr_int))
		 return FALSE;
	 if (!xdr_int (xdrs, &objp->return_code))
		 return FALSE;
	return TRUE;
...
bool_t
xdr_qcsapi_get_device_mode_rpcdata (XDR *xdrs, qcsapi_get_device_mode_rpcdata *objp)
{
	register int32_t *buf;

	 if (!xdr_pointer (xdrs, (char **)&objp->ifname, sizeof (__rpc_string), (xdrproc_t) xdr___rpc_string))
		 return FALSE;
	 if (!xdr_pointer (xdrs, (char **)&objp->cur_mode, sizeof (int), (xdrproc_t) xdr_int))
		 return FALSE;
	 if (!xdr_int (xdrs, &objp->return_code))
		 return FALSE;
	return TRUE;
...
bool_t
xdr_qcsapi_get_stored_ipaddr_rpcdata (XDR *xdrs, qcsapi_get_stored_ipaddr_rpcdata *objp)
{
	register int32_t *buf;

	 if (!xdr_u_int (xdrs, &objp->maxlen))
		 return FALSE;
	 if (!xdr_pointer (xdrs, (char **)&objp->ipaddr, sizeof (__rpc_string), (xdrproc_t) xdr___rpc_string))
		 return FALSE;
	 if (!xdr_int (xdrs, &objp->return_code))
		 return FALSE;
	return TRUE;
...
bool_t
xdr_qcsapi_wifi_associate_noscan_rpcdata (XDR *xdrs, qcsapi_wifi_associate_noscan_rpcdata *objp)
{
	register int32_t *buf;
...
bool_t
xdr_qcsapi_wifi_set_autochan_params_rpcdata (XDR *xdrs, qcsapi_wifi_set_autochan_params_rpcdata *objp)
{
	register int32_t *buf;
...
bool_t
xdr_qcsapi_wifi_get_autochan_params_rpcdata (XDR *xdrs, qcsapi_wifi_get_autochan_params_rpcdata *objp)
{
	register int32_t *buf;
...
bool_t
xdr_qcsapi_wifi_update_autochan_params_rpcdata (XDR *xdrs, qcsapi_wifi_update_autochan_params_rpcdata *objp)
{
	register int32_t *buf;
...
bool_t
xdr_qcsapi_wifi_wds_get_psk_rpcdata (XDR *xdrs, qcsapi_wifi_wds_get_psk_rpcdata *objp)
{
	register int32_t *buf;
	 ...
	 if (!xdr___rpc_qcsapi_mac_addr_p (xdrs, &objp->peer_address))
		 return FALSE;
	 if (!xdr_pointer (xdrs, (char **)&objp->pre_shared_key, sizeof (uint8_t), (xdrproc_t) xdr_uint8_t))
		 return FALSE;
	 if (!xdr_pointer (xdrs, (char **)&objp->key_len, sizeof (uint8_t), (xdrproc_t) xdr_uint8_t))
		 return FALSE;
	 if (!xdr_int (xdrs, &objp->return_code))
		 return FALSE;
	return TRUE;
...
bool_t
xdr_qcsapi_wifi_set_eap_own_ip_addr_rpcdata (XDR *xdrs, qcsapi_wifi_set_eap_own_ip_addr_rpcdata *objp)
{
	register int32_t *buf;

	 if (!xdr_pointer (xdrs, (char **)&objp->ifname, sizeof (__rpc_string), (xdrproc_t) xdr___rpc_string))
		 return FALSE;
	 if (!xdr_pointer (xdrs, (char **)&objp->eap_own_ip_addr, sizeof (__rpc_string), (xdrproc_t) xdr___rpc_string))
		 return FALSE;
	 if (!xdr_int (xdrs, &objp->return_code))
		 return FALSE;
	return TRUE;
...
bool_t
xdr_qcsapi_wifi_get_eap_own_ip_addr_rpcdata (XDR *xdrs, qcsapi_wifi_get_eap_own_ip_addr_rpcdata *objp)
{
	register int32_t *buf;
...
bool_t
xdr_qcsapi_wifi_get_radius_acct_interim_interval_rpcdata (XDR *xdrs, qcsapi_wifi_get_radius_acct_interim_interval_rpcdata *objp)
{
	register int32_t *buf;

	 if (!xdr_pointer (xdrs, (char **)&objp->ifname, sizeof (__rpc_string), (xdrproc_t) xdr___rpc_string))
		 return FALSE;
	 if (!xdr_pointer (xdrs, (char **)&objp->interval, sizeof (u_int), (xdrproc_t) xdr_u_int))
		 return FALSE;
	 if (!xdr_int (xdrs, &objp->return_code))
		 return FALSE;
	return TRUE;
...
bool_t
xdr_qcsapi_wifi_set_radius_acct_interim_interval_rpcdata (XDR *xdrs, qcsapi_wifi_set_radius_acct_interim_interval_rpcdata *objp)
{
	register int32_t *buf;

	 if (!xdr_pointer (xdrs, (char **)&objp->ifname, sizeof (__rpc_string), (xdrproc_t) xdr___rpc_string))
		 return FALSE;
	 if (!xdr_u_int (xdrs, &objp->interval))
		 return FALSE;
	 if (!xdr_int (xdrs, &objp->return_code))
		 return FALSE;
	return TRUE;
...
bool_t
xdr_qcsapi_wifi_add_temporary_mac_filter_addr_rpcdata (XDR *xdrs, qcsapi_wifi_add_temporary_mac_filter_addr_rpcdata *objp)
{
	register int32_t *buf;

	 if (!xdr_pointer (xdrs, (char **)&objp->ifname, sizeof (__rpc_string), (xdrproc_t) xdr___rpc_string))
		 return FALSE;
	 if (!xdr_pointer (xdrs, (char **)&objp->accept_deny, sizeof (__rpc_string), (xdrproc_t) xdr___rpc_string))
		 return FALSE;
	 if (!xdr___rpc_qcsapi_mac_addr_p (xdrs, &objp->address))
		 return FALSE;
	 if (!xdr_int (xdrs, &objp->return_code))
		 return FALSE;
	return TRUE;
...
bool_t
xdr_qcsapi_wifi_del_temporary_mac_filter_addr_rpcdata (XDR *xdrs, qcsapi_wifi_del_temporary_mac_filter_addr_rpcdata *objp)
{
	register int32_t *buf;
...
bool_t
xdr_qcsapi_wps_configure_ap_rpcdata (XDR *xdrs, qcsapi_wps_configure_ap_rpcdata *objp)
{
	register int32_t *buf;

	 if (!xdr_pointer (xdrs, (char **)&objp->ifname, sizeof (__rpc_string), (xdrproc_t) xdr___rpc_string))
		 return FALSE;
	 if (!xdr_pointer (xdrs, (char **)&objp->bssid, sizeof (__rpc_string), (xdrproc_t) xdr___rpc_string))
		 return FALSE;
	 if (!xdr_pointer (xdrs, (char **)&objp->ap_pin, sizeof (__rpc_string), (xdrproc_t) xdr___rpc_string))
		 return FALSE;
	 if (!xdr_pointer (xdrs, (char **)&objp->new_ssid, sizeof (__rpc_string), (xdrproc_t) xdr___rpc_string))
		 return FALSE;
	 if (!xdr_pointer (xdrs, (char **)&objp->new_auth, sizeof (__rpc_string), (xdrproc_t) xdr___rpc_string))
		 return FALSE;
	 if (!xdr_pointer (xdrs, (char **)&objp->new_encr, sizeof (__rpc_string), (xdrproc_t) xdr___rpc_string))
		 return FALSE;
	 if (!xdr_pointer (xdrs, (char **)&objp->new_key, sizeof (__rpc_string), (xdrproc_t) xdr___rpc_string))
		 return FALSE;
	 if (!xdr_int (xdrs, &objp->return_code))
		 return FALSE;
	return TRUE;
...
bool_t
xdr_qcsapi_wifi_set_rx_nss_cap_rpcdata (XDR *xdrs, qcsapi_wifi_set_rx_nss_cap_rpcdata *objp)
{
	register int32_t *buf;
...
bool_t
xdr_qcsapi_wifi_get_rx_nss_cap_rpcdata (XDR *xdrs, qcsapi_wifi_get_rx_nss_cap_rpcdata *objp)
{
	register int32_t *buf;
...
bool_t
xdr_qcsapi_wifi_get_btm_cap_rpcdata (XDR *xdrs, qcsapi_wifi_get_btm_cap_rpcdata *objp)
{
	register int32_t *buf;

	 if (!xdr_pointer (xdrs, (char **)&objp->ifname, sizeof (__rpc_string), (xdrproc_t) xdr___rpc_string))
		 return FALSE;
	 if (!xdr_pointer (xdrs, (char **)&objp->btm_cap, sizeof (int), (xdrproc_t) xdr_int))
		 return FALSE;
	 if (!xdr_int (xdrs, &objp->return_code))
		 return FALSE;
	return TRUE;
...
bool_t
xdr_qcsapi_wifi_set_btm_cap_rpcdata (XDR *xdrs, qcsapi_wifi_set_btm_cap_rpcdata *objp)
{
	register int32_t *buf;

	 if (!xdr_pointer (xdrs, (char **)&objp->ifname, sizeof (__rpc_string), (xdrproc_t) xdr___rpc_string))
		 return FALSE;
	 if (!xdr_int (xdrs, &objp->btm_cap))
		 return FALSE;
	 if (!xdr_int (xdrs, &objp->return_code))
		 return FALSE;
	return TRUE;
...
bool_t
xdr_qcsapi_wifi_get_rm_neigh_report_rpcdata (XDR *xdrs, qcsapi_wifi_get_rm_neigh_report_rpcdata *objp)
{
	register int32_t *buf;

	 if (!xdr_pointer (xdrs, (char **)&objp->ifname, sizeof (__rpc_string), (xdrproc_t) xdr___rpc_string))
		 return FALSE;
	 if (!xdr_pointer (xdrs, (char **)&objp->neigh_repo, sizeof (int), (xdrproc_t) xdr_int))
		 return FALSE;
	 if (!xdr_int (xdrs, &objp->return_code))
		 return FALSE;
	return TRUE;
...
bool_t
xdr_qcsapi_wifi_set_rm_neigh_report_rpcdata (XDR *xdrs, qcsapi_wifi_set_rm_neigh_report_rpcdata *objp)
{
	register int32_t *buf;

	 if (!xdr_pointer (xdrs, (char **)&objp->ifname, sizeof (__rpc_string), (xdrproc_t) xdr___rpc_string))
		 return FALSE;
	 if (!xdr_int (xdrs, &objp->neigh_repo))
		 return FALSE;
	 if (!xdr_int (xdrs, &objp->return_code))
		 return FALSE;
	return TRUE;
...
bool_t
xdr_qcsapi_set_unknown_dest_discover_intval_rpcdata (XDR *xdrs, qcsapi_set_unknown_dest_discover_intval_rpcdata *objp)
{
	register int32_t *buf;

	 if (!xdr_pointer (xdrs, (char **)&objp->ifname, sizeof (__rpc_string), (xdrproc_t) xdr___rpc_string))
		 return FALSE;
	 if (!xdr_u_int (xdrs, &objp->intval))
		 return FALSE;
	 if (!xdr_int (xdrs, &objp->return_code))
		 return FALSE;
	return TRUE;
...
bool_t
xdr_qcsapi_get_unknown_dest_discover_intval_rpcdata (XDR *xdrs, qcsapi_get_unknown_dest_discover_intval_rpcdata *objp)
{
	register int32_t *buf;

	 if (!xdr_pointer (xdrs, (char **)&objp->ifname, sizeof (__rpc_string), (xdrproc_t) xdr___rpc_string))
		 return FALSE;
	 if (!xdr_pointer (xdrs, (char **)&objp->intval, sizeof (u_int), (xdrproc_t) xdr_u_int))
		 return FALSE;
	 if (!xdr_int (xdrs, &objp->return_code))
		 return FALSE;
	return TRUE;
...
bool_t
xdr_qcsapi_calcmd_check_rfic_health_rpcdata (XDR *xdrs, qcsapi_calcmd_check_rfic_health_rpcdata *objp)
{
	register int32_t *buf;
...
bool_t
xdr_qcsapi_get_app_core_dump_ext_rpcdata (XDR *xdrs, qcsapi_get_app_core_dump_ext_rpcdata *objp)
{
	register int32_t *buf;
	 ...
	 if (!xdr_pointer (xdrs, (char **)&objp->bytes_copied, sizeof (uint32_t), (xdrproc_t) xdr_uint32_t))
		 return FALSE;
	 if (!xdr_pointer (xdrs, (char **)&objp->bytes_remaining, sizeof (uint32_t), (xdrproc_t) xdr_uint32_t))
		 return FALSE;
	 if (!xdr_int (xdrs, &objp->return_code))
		 return FALSE;
	return TRUE;
...
bool_t
xdr_qcsapi_wifi_get_vopt_rpcdata (XDR *xdrs, qcsapi_wifi_get_vopt_rpcdata *objp)
{
	register int32_t *buf;

	 if (!xdr_pointer (xdrs, (char **)&objp->ifname, sizeof (__rpc_string), (xdrproc_t) xdr___rpc_string))
		 return FALSE;
	 if (!xdr_pointer (xdrs, (char **)&objp->vopt_value, sizeof (int), (xdrproc_t) xdr_int))
		 return FALSE;
	 if (!xdr_int (xdrs, &objp->return_code))
		 return FALSE;
	return TRUE;
...
bool_t
xdr_qcsapi_wifi_set_vopt_rpcdata (XDR *xdrs, qcsapi_wifi_set_vopt_rpcdata *objp)
{
	register int32_t *buf;

	 if (!xdr_pointer (xdrs, (char **)&objp->ifname, sizeof (__rpc_string), (xdrproc_t) xdr___rpc_string))
		 return FALSE;
	 if (!xdr_int (xdrs, &objp->vopt_value))
		 return FALSE;
	 if (!xdr_int (xdrs, &objp->return_code))
		 return FALSE;
	return TRUE;
...
bool_t
xdr_qcsapi_set_report_flood_interval_rpcdata (XDR *xdrs, qcsapi_set_report_flood_interval_rpcdata *objp)
{
	register int32_t *buf;

	 if (!xdr_pointer (xdrs, (char **)&objp->ifname, sizeof (__rpc_string), (xdrproc_t) xdr___rpc_string))
		 return FALSE;
	 if (!xdr_uint32_t (xdrs, &objp->val))
		 return FALSE;
	 if (!xdr_int (xdrs, &objp->return_code))
		 return FALSE;
	return TRUE;
...
bool_t
xdr_qcsapi_get_report_flood_interval_rpcdata (XDR *xdrs, qcsapi_get_report_flood_interval_rpcdata *objp)
{
	register int32_t *buf;

	 if (!xdr_pointer (xdrs, (char **)&objp->ifname, sizeof (__rpc_string), (xdrproc_t) xdr___rpc_string))
		 return FALSE;
	 if (!xdr_pointer (xdrs, (char **)&objp->val, sizeof (uint32_t), (xdrproc_t) xdr_uint32_t))
		 return FALSE;
	 if (!xdr_int (xdrs, &objp->return_code))
		 return FALSE;
	return TRUE;
...
bool_t
xdr_qcsapi_get_pd_voltage_level_rpcdata (XDR *xdrs, qcsapi_get_pd_voltage_level_rpcdata *objp)
{
	register int32_t *buf;

	 if (!xdr_pointer (xdrs, (char **)&objp->p_chains, sizeof (int), (xdrproc_t) xdr_int))
		 return FALSE;
	 if (!xdr_pointer (xdrs, (char **)&objp->p_values, sizeof (__rpc_qcsapi_int_array32), (xdrproc_t) xdr___rpc_qcsapi_int_array32))
		 return FALSE;
	 if (!xdr_int (xdrs, &objp->return_code))
		 return FALSE;
	return TRUE;
...
bool_t
xdr_qcsapi_wifi_reload_security_config_rpcdata (XDR *xdrs, qcsapi_wifi_reload_security_config_rpcdata *objp)
{
	register int32_t *buf;
...
bool_t
xdr_qcsapi_enable_emac_sdp_rpcdata (XDR *xdrs, qcsapi_enable_emac_sdp_rpcdata *objp)
{
	register int32_t *buf;
...
bool_t
xdr_qcsapi_wifi_set_bss_rxscan_rpcdata (XDR *xdrs, qcsapi_wifi_set_bss_rxscan_rpcdata *objp)
{
	register int32_t *buf;
